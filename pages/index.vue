<template>
  <div class="space-y-12">
    <section class="text-center space-y-8 pt-16">
      ...
      <NuxtLink to="/listings" class="af-btn-primary inline-block px-6 py-3">Ver alojamientos</NuxtLink>
    </section>
    ...
    <section class="pt-8 pb-12">
      <div class="flex justify-between items-center mb-8">
        ...
        <NuxtLink to="/listings" class="text-primary-600 hover:underline">Ver todos</NuxtLink>
      </div>
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
              ...
              <div class="p-4 space-y-2">
                ...
                <div class="flex justify-between items-center pt-2">
                  <span class="font-bold text-primary-600">{{ property.price }}€/noche</span>
                  <NuxtLink :to="`/listings/${property.id}`" class="text-sm text-primary-600 hover:underline">
                    Ver detalles
                  </NuxtLink>
                </div>
              </div>
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="text-center space-y-3">
            <div class="bg-primary-600 rounded-full w-12 h-12 mx-auto flex items-center justify-center text-white">
...
<style scoped>
/* Importamos las clases de botón definidas en AddListingModal o definirlas globalmente */
/* Aquí usamos clases directas de Tailwind para el botón */
.af-btn-primary {
  @apply bg-[#FF5A5F] text-white rounded-lg transition hover:bg-opacity-90;
}
